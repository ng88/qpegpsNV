...
DownloadSpecification::DownloadSpecification(GpsData *gData, MapInfo *mapInfo, QSortedList<MapBase> *maps)
{
    gpsData = gData;
    mapList = maps;
...
DownLoadDialog::DownLoadDialog(GpsData *gData, MapInfo *mapInfo, QSortedList <MapBase>*maps, QWidget *parent,
        ...
        QDialog(parent,name,modal,f)
{
    ...
    mapWidget->resize(((MapInfo*)parent)->image->width(), ((MapInfo*)parent)->image->height());
...
ChangeMapParDialog::ChangeMapParDialog(QSortedList <MapBase>*maps, QWidget *parent=0,
                                       const char *name=0, bool modal=FALSE,WFlags f=0):
        QDialog(parent,name,modal,f)
{
    vBox = new QVBox(this);
...
DownloadAreaSpecification::~DownloadAreaSpecification(){}	/* Added by A. Karkhov */

DownloadAreaSpecification::DownloadAreaSpecification(GpsData *gData, MapInfo *mapInfo, QSortedList<MapBase> *maps)
{
    gpsData = gData;
    mapList = maps;
...
DownLoadAreaDialog::DownLoadAreaDialog(Qpegps *application, DownloadAreaSpecification *spec, GpsData *gData, MapInfo *mapInfo, QSortedList <MapBase>*maps, QWidget *parent,	/* Added by A. Karkhov */
                               const char *name, bool modal,WFlags f):
        QDialog(parent,name,modal,f)	/* Added by A. Karkhov */
{
    gpsData = gData;
    mapList = maps;
...
DownLoadAreaDialog::~DownLoadAreaDialog(){}	/* Added by A. Karkhov */

DownloadAreaWidget::~DownloadAreaWidget(){}		/* Added by A. Karkhov */
